    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        btnRegister.setOnClickListener {
            if (agreeToTerms.isChecked) {
                ...
                Toast.makeText(requireActivity().applicationContext, "To finish registration you have to agree to the privacy policy",
        ...
        tvPrivacyPolicy.setOnClickListener {
            ...
            builder!!.setMessage("**Privacy Policy**\n" +
                    "\n" +
                    "NearPeer Team built the NearPeer app as a Free app. This SERVICE is provided by NearPeer Team at no cost and is intended for use as is.\n" +
                    "\n" +
                    ...
                    "**Contact Us**\n" +
                    "\n" +
                    "If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact us at enar.warfvinge@iths.se or alva.hemmingsson@iths.se\n")
                .setCancelable(false)
